var engine = {
    "cores": ['green','purple','pink','red','yellow','orange','grey','black','cyan','darkGreen','goldenrod','chocolate','indigo','purple','gold','salmon',],
    "hexadecimais":{
      'green':'#02EF00',
      'purple':'#790093',
      'pink': '#F02A7E',
...
const audioMoeda = new Audio('Sound/moeda.mp3');
const audioErrou = new Audio('Sound/errou.mp3');
...
function aplicarCorNaCaixa(nomeDaCor){
  ...
  caixaDasCores.style.backgroundImage = "url('Image/caixa-fechada.png')";
